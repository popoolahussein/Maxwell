...
const SplashScreen3: React.FC<SplashScreenProps> = ({ onNext }) => (
  <View style={styles.container}>
    ...
    <Image source={require('../../assets/indicators/indicator-c1.png')} style={styles.slideIndicator} />
    </Pressable>
    <TouchableOpacity style={styles.button} onPress={onNext}>
      <Image source={require('../../assets/indicators/indicator-c.png')} style={styles.buttonImage} />
    </TouchableOpacity>
    </View>
    </View>
  </View>
