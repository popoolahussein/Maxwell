...
const SplashScreen5: React.FC<SplashScreenProps> = ({ onNext }) => (
  <View style={styles.container}>
    <ImageBackground source={require('../../assets/Img/splash5.png')} style={styles.backgroundImage}>
    <LinearGradient
    ...
    <Image source={require('../../assets/indicators/indicator-e1.png')} style={styles.slideIndicator} />
    </Pressable>
    <TouchableOpacity style={styles.button} onPress={onNext}>
      <Image source={require('../../assets/indicators/indicator-e.png')} style={styles.buttonImage} />
    </TouchableOpacity>
    </View>
    </View>
  </View>
