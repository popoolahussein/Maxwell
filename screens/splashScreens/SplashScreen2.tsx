...
const SplashScreen2: React.FC<SplashScreenProps> = ({ onNext }) => (
  <View style={styles.container}>
    <ImageBackground source={require('../../assets/Img/splash2.png')} style={styles.backgroundImage}>
    <LinearGradient
    ...
    <Image source={require('../../assets/indicators/indicator-b1.png')} style={styles.slideIndicator} />
    </Pressable>
    <TouchableOpacity style={styles.button} onPress={onNext}>
      <Image source={require('../../assets/indicators/indicator-b.png')} style={styles.buttonImage} />
    </TouchableOpacity>
    </View>
    </View>
  </View>
